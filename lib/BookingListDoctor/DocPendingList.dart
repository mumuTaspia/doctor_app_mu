...
class DoctorPendingList extends StatefulWidget {
  @override
  _BookingListByDoctorState createState() => _BookingListByDoctorState();
}

class _BookingListByDoctorState extends State<DoctorPendingList> {
  ...
  Future getBookingList() async {
    ...
    print(userid);
    final responce = await http.post("https://doctor-api.appstic.xyz/appointmentbystatusdoctor/pending/"+userid);
